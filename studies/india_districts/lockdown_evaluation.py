...
if __name__ == "__main__":
    ...
    root = cwd()
    data = root/"data"
    states     = ["Tamil Nadu", 'Bihar', 'Andhra Pradesh', 'Uttar Pradesh', 'Maharashtra', 'Punjab', 'Tamil Nadu', 'West Bengal', 'Kerala', 'Gujarat']
