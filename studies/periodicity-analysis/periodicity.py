...
plt.plot(yff, label = "notch-filtered")
plt.plot(convolve(yff, window(10)), label = "10 day convolution")
plt.plot(convolve(yff, window(20)), label = "20 day convolution")
plt.legend()
plt.title("Non-Causal Smoothing", loc="left", fontdict=title_font)
plt.show()

plt.plot(yff, label = "notch-filtered")
plt.plot(convolve(yff, window(10), mode ="same"), label = "10 day convolution")
plt.plot(convolve(yff, window(20), mode ="same"), label = "20 day convolution")
plt.legend()
...
plt.plot(convolve(np.concatenate([yff, yff[:-6:-1]]),  window(5),  mode ="same"), label = "5  day convolution (padded)", alpha = 0.5)
plt.plot(convolve(np.concatenate([yff, yff[:-8:-1]]),  window(7),  mode ="same"), label = "7  day convolution (padded)", alpha = 0.5)
plt.plot(convolve(np.concatenate([yff, yff[:-11:-1]]), window(10), mode ="same"), label = "10 day convolution (padded)", alpha = 0.5)
plt.plot(convolve(np.concatenate([yff, yff[:-21:-1]]), window(20), mode ="same"), label = "20 day convolution (padded)", alpha = 0.5)
plt.legend()
plt.title("Causal Smoothing, with Time-Reversed Padding", loc="left", fontdict=title_font)
plt.show()