...
simulation_initial_conditions = pd.read_csv(data/"focus_states_simulation_initial_conditions.csv")\
...
dst = mkdir(data/f"focus_sim_metrics{num_sims}")
...
if __name__ == "__main__":
    ...
    for ((state, district), state_code, sero_0, N_0, sero_1, N_1, sero_2, N_2, sero_3, N_3, sero_4, N_4, sero_5, N_5, sero_6, N_6, N_tot, Rt, S0, I0, R0, D0, dT0, dD0) in districts_to_run.itertuples():
