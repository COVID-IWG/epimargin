...
from adaptive.utils import annually, percent, years, mkdir
...
phi_points       = [_ * percent * annually for _ in (1000, 5000, 10000, 20000, 50000)]
...
dst = mkdir(data/"sim_metrics_100")
